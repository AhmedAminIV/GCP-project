...
# Tag Docker Image
sudo docker tag node-app:latest us-central1-docker.pkg.dev/amin-final/project-repo/node-app:latest

# Push Docker Image to Artifact Registry
sudo docker push us-central1-docker.pkg.dev/amin-final/project-repo/node-app:latest

# Pull mongodb image
sudo docker pull bitnami/mongodb:4.4.4

# Tag Docker Image
sudo docker tag bitnami/mongodb:4.4.4 us-central1-docker.pkg.dev/amin-final/project-repo/bitnami/mongodb:4.4.4
